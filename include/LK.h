...
//        cout<<lastKeyFrame->mvKeysUn.size()<<endl;
    ...
    cvtColor(last_color,last_gray,CV_BGR2GRAY);//灰度图
...
//    cout<<"tracked keypoints: "<<keypoints.size()<<endl;
    ...
    if(!(mappointInCurrentFrame.empty()||keypoints.empty()||mDistCoef.empty()))
    {
        ...
        cv::solvePnPRansac(mappointInCurrentFrame, keypoints, K, mDistCoef , R_vector, T, false, 50,3, 0.98, ransacInlier);
